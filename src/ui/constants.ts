const TRANSLATIONS = [
  {
    ...
    translations: [
      ...
      },
      {
        short_name: "PPCH",
        full_name:
          "НОВИЙ ЗАВІТ. Новий переклад Юрія Попченка з давньогрецької на сучасну українську літературну мову",
        updated: 1735480286432,
      },
      {
        short_name: "GYZ",
        full_name:
          "Канонічний переклад Біблії сучасною українською мовою. Переклав Олександр Гижа. © 2019",
        updated: 1735480286432,
      },
      {
        short_name: "UKDER",
...
].flatMap((l) => l.translations.map((t) => ({ ...t, language: l.language })));
